package com.example.luissancar.conexionarduino02;
        ...
        BotonLed.setOnClickListener(new View.OnClickListener() {
            public void onClick(View vv) {
                ...
                if(BotonLed.isChecked())     {
                    ...
                    sendMessage("1\r");
                    findViewById(R.id.Led1).setBackgroundResource(R.mipmap.ledcamaleon2);
                }
                else {
                    if(D) Log.e("BotonLed", "Apagando..");
                    sendMessage("2\r");
                    findViewById(R.id.Led1).setBackgroundResource(R.mipmap.ledcamaleon1);
                }
            }
